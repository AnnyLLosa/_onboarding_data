...
- The data reveals a clear divergence in school safety trends over the three-year period:
  ...
  - Decrease in number of major crimes (major_n) showed a consistent downward trend, dropping from 652 to 523 (a 19.8% reduction).
    
  - Increase in non-criminal incidents (nocrim_n) increased each year, rising from 3,776 to 4,054 (a 7.4% increase).
